<template>
  ...
  <CollapseItem name="折线图2" :expanded="true">
    ...
    <setting-item-box name="特效">
      <setting-item>
        <n-space>
          <n-switch v-model:value="seriesList[4].effect.show" size="small" />
          <n-text>展示特效</n-text>
        </n-space>
      </setting-item>
      <setting-item name="特效尾迹的长度。取从 0 到 1 的值，数值越大尾迹越长">
        <n-input-number v-model:value="seriesList[4].effect.trailLength" size="small" :max="1"></n-input-number>
      </setting-item>
      <setting-item name="特效动画的时间，单位为 s。">
        <n-input-number v-model:value="seriesList[4].effect.period" size="small" :min="0"></n-input-number>
      </setting-item>
      <setting-item name="特效大小">
        <n-input-number v-model:value="seriesList[4].effect.symbolSize" size="small" :min="0"></n-input-number>
      </setting-item>
      <setting-item name="特效颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="seriesList[4].lineStyle.normal.color"></n-color-picker>
      </setting-item>
    </setting-item-box>
  </CollapseItem>
  <CollapseItem name="折线图3" :expanded="true">
    <SettingItemBox name="线条">
      <SettingItem name="线条宽度">
        <n-input-number
      ...
      <SettingItem name="类型">
        <n-select v-model:value="seriesList[2].lineStyle.normal.type" size="small" :options="lineConf.lineStyle.type"></n-select>
      </SettingItem>
      <setting-item name="折线颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="seriesList[2].lineStyle.normal.color"></n-color-picker>
      </setting-item>
      <setting-item name="区域面积颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="seriesList[2].areaStyle.normal.color"></n-color-picker>
      </setting-item>
      <setting-item name="区域面积透明度，取0~1之间的数字，默认0.8">
        <n-input-number v-model:value="seriesList[2].areaStyle.normal.opacity" size="small" :min="0" :max="1"></n-input-number>
      </setting-item>
    </SettingItemBox>
    <SettingItemBox name="节点">
      <SettingItem name="大小">
        <n-input-number
                v-model:value="seriesList[2].symbolSize"
                :min="1"
                :max="100"
                size="small"
                placeholder="自动计算"
    ...
    <SettingItemBox name="标签">
      ...
      <SettingItem name="字体大小">
        <n-input-number v-model:value="seriesList[2].label.fontSize" size="small" :min="1"></n-input-number>
      </SettingItem>
      <setting-item name="颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="seriesList[2].label.textStyle.color"></n-color-picker>
      </setting-item>
      <setting-item name="位置">
        <n-select
    ...
    <setting-item-box name="特效">
      <setting-item>
        <n-space>
          <n-switch v-model:value="seriesList[5].effect.show" size="small" />
          <n-text>展示特效</n-text>
        </n-space>
      </setting-item>
      <setting-item name="特效尾迹的长度。取从 0 到 1 的值，数值越大尾迹越长">
        <n-input-number v-model:value="seriesList[5].effect.trailLength" size="small" :max="1"></n-input-number>
      </setting-item>
      <setting-item name="特效动画的时间，单位为 s。">
        <n-input-number v-model:value="seriesList[5].effect.period" size="small" :min="0"></n-input-number>
      </setting-item>
      <setting-item name="特效大小">
        <n-input-number v-model:value="seriesList[5].effect.symbolSize" size="small" :min="0"></n-input-number>
      </setting-item>
      <setting-item name="特效颜色">
        <n-color-picker size="small" :modes="['hex']" v-model:value="seriesList[5].lineStyle.normal.color"></n-color-picker>
      </setting-item>
    </setting-item-box>
  </CollapseItem>
