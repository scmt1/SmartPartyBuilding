<template>
  ...
  <collapse-item name="样式" :expanded="true">
    <setting-item-box name="文字">
      ...
      <SettingItem name="字体类型">
        <n-select v-model:value="optionData.fontFamily" size="small" :options="fontFamilyOptions" />
      </SettingItem>
...
const fontFamilyOptions = [
  {label: '非衬线字体', value: 'sans-serif'},
  {label: '衬线字体', value: 'serif'},
  {label: '等宽字体', value: 'monospace'},
  {label: 'Arial', value: 'Arial'},
  {label: '手写体', value: 'Courier New'},
