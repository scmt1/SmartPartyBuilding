<template>
    <el-dialog :visible.sync="modal" :width="(autoCropWidth + 60) + 'px'" title="图片剪裁" append-to-body>
        <div :style="'height: '+ (autoCropHeight + 40) +'px;width: auto;text-align: center;'">
            <VueCropper
                ref="cropper"
                :img="option.img"
