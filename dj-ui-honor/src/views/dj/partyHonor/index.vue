        ...
        <tree-and-table>
            ...
            <template v-slot:table>
                <el-table
                    ...
                    <el-table-column label="操作" v-if="leaf" fixed="right" width="150">
                        <template slot-scope="scope">
...
import {queryTzPartyHonorList, delTzPartyHonor} from "@/api/TzPartyHonor";
import util from "@/libs/util";
import Edit from "./edit.vue";
import organizationTree from '@/views/dj/components/organizationTree'
import {getTzSysDept} from "@/api/tzSysDept";
