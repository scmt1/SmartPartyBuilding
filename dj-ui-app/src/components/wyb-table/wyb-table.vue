<template>
	<view class="wyb-table-box" style="padding: 10rpx; background-color: white; border-radius: 10rpx;">
		<view v-if="loading" class="wyb-table-loading-box" :style="{
			...
			<view>
				<image style="max-width: 30vw;height: 100rpx;" src="../../static/gif3.gif" mode="aspectFit" />
			</view>
		</view>
      ...
      <view class="wyb-table-header" :style="{borderBottom: '1px solid' + borderColor}">
		...
		<view v-if="!loading" ref="scrollView" class="wyb-table-scroll-view" :style="{
			//width: width,
			height: height,
