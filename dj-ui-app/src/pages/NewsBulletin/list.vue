...
<!--                                    {{item.categoryList[0].id == 21 ? '机关动态' : item.categoryList[0].id == 2 ? '专题专栏' :-->
<!--                                    item.categoryList[0].id == 11 ? '党建信息' : item.categoryList[0].id == 31 ? '先锋典型' : item.categoryList[0].id == 41 ? '党建微视' :''}}-->
<!--                                </view>-->
