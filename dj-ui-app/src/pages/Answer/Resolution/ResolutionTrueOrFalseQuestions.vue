<template>
	<view v-loading="loading" class="content-box">
		...
		<view class="content">
			<view class="top-box">
				<view class="next-button" @click="$handlerNavigate({ url: '/pages/Answer/Resolution/ResolutionSingleChoice' })">
					上一题
				</view>
				<view class="left-content">

				</view>
				<view class="next-button" @click="$handlerNavigate({ url: '/pages/Answer/Resolution/ResolutionMultipleChoice' })">
					下一题
				</view>
			</view>
			...
			<view class="topic-box">
				<view class="name-box">
					...
					<view class="text">判断题(20分)</view>
					<view class="error">回答错误</view>
					<view>
						<text class="num-left">2</text>
				...
				<view class="main-content-box">
					...
					<view class="button-box">
						<view :class="selectedId == 1?'button-selected':'button'">
							正确
						</view>
						<view :class="selectedId == 2?'button-selected':'button'">
							错误
						</view>
					</view>
				</view>
			...
			<view class="topic-box">
				...
				<view class="answer-box">
					<view class="answer-text1">您的答案：正确</view>
					<view class="answer-text2">正确答案：错误</view>
				</view>
				<view class="main-content-box">
					<view style="font-size: 30rpx; line-height: 45rpx;">
						2021年10月12日，习近平在《生物多样性公约》第十五次缔约方大会领导人峰会上指出昆明大会以“生态文明: 共建地球生命共同32为未来全球体”为主题，推动制定生物多样性保护具有重要意义。
...
export default {
	name: 'ResolutionTrueOrFalseQuestions',
	data() {
		return {
			selectedId: 2
		}
