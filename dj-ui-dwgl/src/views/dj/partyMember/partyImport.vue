                        ...
                        <div class="col-sm-6">
                            <el-form-item label="需要上传的文件:" label-width="120px">
                                <div style="display: flex">
                                    <el-input value="请选择需要上传的文件" placeholder="需要上传的文件"
                                    ...
                                    <Upload
                                        ...
                                        <div style="display: flex;height: 40px">
                                            <!--<el-input value="请选择需要上传的文件" placeholder="需要上传的文件" autocomplete="off" style="width:240px;" :disabled="true"></el-input>-->
                                            <!--<el-input v-model="whereMap.realName" placeholder="请输入姓名" size="small" style="width: 200px;margin-left: 15px"></el-input>-->
                                            <!--<el-button size="mini" style="width: 100px" v-if="fileList.length<1">上传文件</el-button>-->
                                    ...
                                    <el-button :disabled="true" size="mini" style="width: 100px" v-else>上传文件
                                    </el-button>
                                </div>
                            </el-form-item>
                            <div v-if="infoShow">
...
export default {
    ...
    methods: {
        ...
        getApi() {
            return util.upload + '/platform/partyMember/partyImport'
        },
        getDeptName(deptId) {
        ...
        getdict(type) {
            ...
            getDictByCode(type).then((res) => {
                if (type === 'nation') {
                    ...
                    this.developStateList = res.data.data
