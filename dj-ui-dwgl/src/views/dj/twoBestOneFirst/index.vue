    ...
    <tree-and-table>
        ...
        <template v-slot:search>
            <el-form ref="searchForm" :model="search" label-width="90px" inline size="medium" style="text-align: left;">
                <el-form-item prop="tableType" label="类型：">
                    <el-select v-model="search.tableType" placeholder="请选择"
                ...
                <el-form-item prop="commendType" label="表彰/表扬：">
                    <el-select v-model="search.commendType" placeholder="请选择" clearable
                               style="width: 200px;">
                ...
                <el-form-item style="margin-left: 20px;">
                    <el-button size="small" icon="el-icon-search" @click="ok()"
                               style="background: rgba(228, 53, 43, 1);color:#ffffff;border-color: rgb(228, 53, 43);">搜索
                    </el-button>
                    <el-button size="small" @click="resetForm('searchForm')">重置</el-button>
                    <el-button size="small" icon="el-icon-download" @click="exportProvinceData"
                               style="background: rgba(228, 53, 43, 1);color:#ffffff;border-color: rgb(228, 53, 43);">
                        导出勾选
                    </el-button>
                </el-form-item>
            </el-form>
        ...
        <template v-slot:table>
            <el-table
                ...
                <el-table-column label="申请批次" width="180" show-overflow-tooltip>
                ...
                <el-table-column label="学历" prop="" width="140" show-overflow-tooltip>
                    <template slot-scope="scope">
                        {{
                ...
                <el-table-column label="工作单位" width="290" show-overflow-tooltip>
                    <template slot-scope="scope">
                ...
                <el-table-column label="提交时间" prop="updateTime" width="180"></el-table-column>
                <el-table-column label="操作" fixed="right" width="120">
                    <template slot-scope="scope">
                        <el-button size="mini" class="button button-blue" @click="handDetail(scope.row.id)">详情/审核
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-table
                    ...
                    :key="Math.random()">
                <el-table-column type="selection" width="55"></el-table-column>
                <el-table-column label="申请批次" width="120" show-overflow-tooltip>
                    <template slot-scope="scope">
                        {{ scope.row.timeInfo && scope.row.timeInfo != null ? scope.row.timeInfo.title : '' }}
                    </template>
                </el-table-column>
        ...
        <template v-slot:pagination>
            ...
            <edit ref="edit" :value="editShow" :id="selectId" @close="editShow = false" @refresh="refresh"></edit>
...
export default {
    ...
    methods: {
        ...
        selectByTree(event) {
            this.selectDeptId = event.whereMap.deptId
            this.queryPage()
        },
        getDeptId(data) {
