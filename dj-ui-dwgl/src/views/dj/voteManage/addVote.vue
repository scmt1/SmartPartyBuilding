        ...
        <div class="modal-content" @click="OptionCardClose">
            <div class="body">
                <el-form ref="form" :model="form" :rules="rules" :disabled="disabled">
                    <div class="row">
                        <div class="col-sm-6">
                            <el-form-item label="活动标题：" :label-width="formLabelWidth" class="input-row" prop="name">
                            ...
                            <el-form-item label="活动说明：" :label-width="formLabelWidth" class="input-row" prop="voteDescription">
                                <el-input v-model="form.voteDescription" placeholder="请输入投票说明(不超过2000字符)" maxlength="2000" size="small" type="textarea" :rows="6" class="input-row"></el-input>
                            </el-form-item>
                            <el-form-item label="发起组织：" :label-width="formLabelWidth" class="input-row" prop="startDept">
                                <el-input v-model="form.startDept" placeholder="请输入发起组织" maxlength="30" size="small" class="input-row" :disabled="true"></el-input>
                            </el-form-item>

                            <el-form-item label="是否记名：" :label-width="formLabelWidth" class="input-row" prop="isScore">
                                <el-select v-model="form.isScore" placeholder="请选择" clearable size="small" class="input-row">
                                    <el-option v-for="(item,index) in isScoreList" :label="item.title" :value="item.value" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="投票次数：" :label-width="formLabelWidth" class="phone" prop="numberTimes">
                                <el-input-number v-model="form.numberTimes" :min="1" :step="1" step-strictly type="number" size="small" class="input-row"></el-input-number>
                                <span style="font-size: 12px;">每人可投票次数，默认1次</span>
                            </el-form-item>
                            <el-form-item label="投票结果：" :label-width="formLabelWidth" class="input-row" prop="voteResult">
                                <el-select v-model="form.voteResult" placeholder="请选择" clearable size="small" class="input-row">
                                    <el-option v-for="(item,index) in voteResultList" :label="item.title" :value="item.value" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="投票类型：" :label-width="formLabelWidth" class="input-row" prop="voteResult">
                                <el-select v-model="form.voteType" placeholder="请选择" clearable size="small" class="input-row">
                                    <el-option v-for="(item,index) in voteTypeList" :label="item.title" :value="item.value" :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                        </div>
                        <div class="col-sm-6">
