...
// let gatewayUrl = "http://192.168.30.56:8097/gateway";
let gatewayUrl = "http://127.0.0.1:7097/gateway";
// 机关工委
// let gatewayUrl = "http://101.206.141.236:7097/gateway";
// let gatewayUrl = "http://10.4.117.31:7097/gateway";
// let gatewayUrl = "/gatewayApi";
...
bsinRequest.interceptors.request.use((url, options) => {
    ...
    if (userId) {
        options.bizParams.userId = userId
    }
