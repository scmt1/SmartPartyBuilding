...
export const getInfo = (deptId) => {
    return request('/getStatisticsInfo', {
        serviceName: serviceName,
...
export const getPartMemberListByDeptIds = (id) => {
    return request('/getPartMemberListByDeptIds', {
        serviceName: serviceName,
        methodName: 'getPartMemberListByDeptIds',
        bizParams: {
            deptId: id
        }
    })
...
export const resetDeptTreePartyMemberPassword = (id) => {
    return request('/resetDeptTreePartyMemberPassword', {
        serviceName: serviceName,
        methodName: 'resetDeptTreePartyMemberPassword',
        bizParams: {
            deptId: id + ''
        }
    })
...
export const getPartyMemberNoEncrypt = () => {
    return request('/getPartyMemberNoEncrypt', {
        serviceName: serviceName,
        methodName: 'getPartyMemberNoEncrypt',
        bizParams: {}
    })
}

export const updatePartyMemberPassWord = () => {
    return request('/updatePartyMemberPassWord', {
        serviceName: serviceName,
        methodName: 'updatePartyMemberPassWord',
        bizParams: {}
    })
}