...
export const getMeetingDecadeCount = (param) => {
...
export const getMeetingDecadeCountGroupByYear = (param) => {
...
export const getMeetingCountNearlyThreeMonths = (id) => {
    return request('/getMeetingCountNearlyThreeMonths', {
        serviceName: serviceName,
        methodName: 'getMeetingCountNearlyThreeMonths',
        bizParams: {
            deptId: id+''
        }
    })
...
export const getMeetingCountByDeptId = (param) => {
    return request('/getMeetingCountByDeptId', {
        serviceName: serviceName,
        methodName: 'getMeetingCountByDeptId',
        bizParams: param
    })
}
