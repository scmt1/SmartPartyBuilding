...
export const queryTzSysDeptLowerLevelList = (params) => {
    return request('/queryTzSysDeptLowerLevelList', {
        serviceName: serviceName,
        methodName: 'queryTzSysDeptLowerLevelList',
        bizParams: {
            ...params
        }
    })
...
export const getTzSysDeptByParentId = (params) => {
    return request('/getTzSysDeptByParentId', {
        serviceName: serviceName,
        methodName: 'getTzSysDeptByParentId',
        bizParams: {
            ...params
        }
    })
