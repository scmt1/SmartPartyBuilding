...
import com.yami.shop.platform.uitls.FileUtil;
...
public class PartyMemberController {
    ...
    public ServerResponseEntity<Object> organizationTransfer(@RequestBody PartyMember partyMember, @RequestBody PartyMemberTransfer partyMemberTransfer) {
        ...
        @NotBlank(message = "用户名不能为空") @Size(min = 2, max = 20, message = "用户名长度要在2-20之间") String username = sysUserService.getSysUserById(SecurityUtils.getSysUser().getUserId()).getUsername();
